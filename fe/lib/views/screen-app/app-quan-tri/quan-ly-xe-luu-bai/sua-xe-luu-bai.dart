...
class SuaXeLuuBai extends StatefulWidget {
  XeLuuBai data;
  Function callBack;
  SuaXeLuuBai({Key? key, required this.callBack, required this.data}) : super(key: key);
  @override
  State<SuaXeLuuBai> createState() => _State();
}

class _State extends State<SuaXeLuuBai> {
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            ElevatedButton(
                                              onPressed: () async {
                                                var abc = await httpPut("/api/xe-luu-bai/put/${data.id}", data.toJson(), context);
                                                print(abc);
                                                showToast(
                                                  context: context,
